...
$_['entry_footer']           = 'Меню в подвале сайта:';
...
// Info
$_['info_footer']            = '<span class="help">Если флажок установлен, тогда категория будет показана в меню Подвала сайта . Данную опцию нужно включать только для главных (родительских) категорий.</span>';
