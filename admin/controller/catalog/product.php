...
class ControllerCatalogProduct extends Controller {
	...
	public function setatten() {
  	...
  	private function getForm() {
		...
		//$this->data['select_square_meter'] = $this->model_catalog_product->SelectSquareMeter($this->request->get['product_id']);
		...
		if (isset($this->request->post['square_meter'])) {
      		$this->data['square_meter'] = $this->request->post['square_meter'];
    	} elseif (!empty($product_info)) {
      		$this->data['square_meter'] = $product_info['square_meter'];
    	} else {
			$this->data['square_meter'] = 0;
		}
		/*Цена за квадратный метр*/
