...
class ControllerModuleUrgently extends Controller {
	protected function index($setting) {
		$this->language->load('module/urgently'); 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/urgently.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/urgently.tpl';
		} else {
			$this->template = 'default/template/module/urgently.tpl';
		}
