...
<head>
    ...
    <!--Стили для разных броузеров и платформа Windows/Linux-->
	<!--<?php if($getplatform == "Windows" || $getplatform == "Linux") {?>
	<?php if($getbrowser == 'Firefox'){?>
	<link rel="stylesheet" href="catalog/view/theme/default/css/windows_linux/gecko/main.css" />
	<link rel="stylesheet" media="(min-width: 641px) and (max-width: 960px)" href="catalog/view/theme/default/css/windows_linux/gecko/main-960.css" />
	<link rel="stylesheet" media="(min-width: 321px) and (max-width: 640px)" href="catalog/view/theme/default/css/windows_linux/gecko/main-640.css" />
	<link rel="stylesheet" media="(max-width: 320px)" href="catalog/view/theme/default/css/windows_linux/gecko/main-320.css" />
	<?php } ?>
	<?php if($getbrowser == 'Chrome' || $getbrowser == 'Mozilla' || $getbrowser == 'Internet Explorer'){?>
	<link rel="stylesheet" href="catalog/view/theme/default/css/windows_linux/webkit/main.css" />
	<link rel="stylesheet" media="(min-width: 641px) and (max-width: 960px)" href="catalog/view/theme/default/css/windows_linux/webkit/main-960.css" />
	<link rel="stylesheet" media="(min-width: 321px) and (max-width: 640px)" href="catalog/view/theme/default/css/windows_linux/webkit/main-640.css" />
	<link rel="stylesheet" media="(max-width: 320px)" href="catalog/view/theme/default/css/windows_linux/webkit/main-320.css" />
	<?php } ?>
    <?php }elseif($getplatform != "Apple"){?>
	<link rel="stylesheet" href="catalog/view/theme/default/css/windows_linux/other/main.css" />
	<link rel="stylesheet" media="(min-width: 641px) and (max-width: 960px)" href="catalog/view/theme/default/css/windows_linux/other/main-960.css" />
	<link rel="stylesheet" media="(min-width: 321px) and (max-width: 640px)" href="catalog/view/theme/default/css/windows_linux/other/main-640.css" />
	<link rel="stylesheet" media="(max-width: 320px)" href="catalog/view/theme/default/css/windows_linux/other/main-320.css" />
	<?php } ?>
	<?php if($getplatform == "Apple") {?>
	<link rel="stylesheet" href="catalog/view/theme/default/css/apple/main.css" />
	<link rel="stylesheet" media="(min-width: 641px) and (max-width: 960px)" href="catalog/view/theme/default/css/apple/main-960.css" />
	<link rel="stylesheet" media="(min-width: 321px) and (max-width: 640px)" href="catalog/view/theme/default/css/apple/main-640.css" />
	<link rel="stylesheet" media="(max-width: 320px)" href="catalog/view/theme/default/css/apple/main-320.css" />
	<?php } ?>-->
...
if (device.portrait()){
    $('head meta[name="viewport"]').append('<meta name="viewport" content="width=320, user-scalable=no">');
}else{
    $('head meta[name="viewport"]').append('<meta name="viewport" content="width=640, user-scalable=no, minimum-scale=1.25, maximum-scale=1.25">');
}
 ...
 function detectIPadOrientation () {
    ...
    if ( orientation == 0 ) {
        ...
        $('head').append('<meta name="viewport" content="width=640, user-scalable=no, minimum-scale=1.25, maximum-scale=1.25">');
    }
    else if ( orientation == -90 ) {
		$('head').append('<meta name="viewport" content="width=640, user-scalable=no, minimum-scale=1.25, maximum-scale=1.25">');
    }
...
if (device.portrait()){
    ...
    $('head meta[name="viewport"]').append('<meta name="viewport" content="width=640, user-scalable=no">');
}
</script>
